...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/1-2': RouteRecordInfo<'/1-2', '/1-2', Record<never, never>, Record<never, never>>,
    '/nav/1/1-4-1': RouteRecordInfo<'/nav/1/1-4-1', '/nav/1/1-4-1', Record<never, never>, Record<never, never>>,
